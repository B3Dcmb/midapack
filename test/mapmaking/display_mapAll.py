...
hp.gnomview(mapI, rot=[0, -57.5], xsize = xsize,reso=6.9, sub = 332, title="Observed Intensity map", notext=True,max = 250, min = -250, cmap=cmap)
hp.gnomview(sky_in.I - mapI, rot=[0, -57.5], xsize=xsize, reso=6.9, sub=333,
            title='Difference', notext=True, min=-25, max=25, cmap = cmap)
...
hp.gnomview(mapQ, rot=[0, -57.5], xsize = xsize,reso=6.9, sub = 335, title="Observed Q map", notext=True, min=-15, max=15, cmap=cmap)
hp.gnomview(sky_in.Q - mapQ, rot=[0, -57.5], xsize=xsize, reso=6.9, sub=336,
            title='Difference', notext=True, min=-25, max=25, cmap = cmap)
...
hp.gnomview(mapU, rot=[0, -57.5], xsize = xsize,reso=6.9, sub = 338, title="Observed U map", notext=True, min=-15, max=15, cmap=cmap)
hp.gnomview(sky_in.U - mapU, rot=[0, -57.5], xsize=xsize, reso=6.9, sub=339,
            title='Difference', notext=True, min=-25, max=25, cmap = cmap)
