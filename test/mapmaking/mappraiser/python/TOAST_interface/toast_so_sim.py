# This file runs an SO time domain simulation and feeds it into MAPPRAISER.
# It was taken from simonsobs/sotodlib/workflows/toast_so_sim.py and adapted for MAPPRAISER.
