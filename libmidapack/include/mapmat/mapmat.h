...
#define ALLTOALLV 5
#define ALLREDUCE 6
//================Modification introduced by Sebastien Cayrols : 01/09/2015 ; Berkeley
...
typedef struct {
  ...
  int *pix_to_last_samp;    // index of the last time sample pointing to each pixel (no nnz repeat factor)
 ...
 *  These are low-level computation routines not really expected to be used by users, e.g., the syntax may evolve unexpectedly,
 *  but may be be found on occasions useful ...
