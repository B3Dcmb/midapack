...
int main_Butterfly_scheme_tests_vButterfly_finale0(int argc, char** argv){
// int main(int argc, char** argv){
...
// int main_Butterfly_scheme_tests_vButterfly_finale1(int argc, char** argv){
int main(int argc, char** argv){
    ...
    if (rank < 3){
        indices_local[size_local-2] = 2000;
        values_local[size_local-2] = 2000.01;
        indices_local[size_local-1] = 3000;
        values_local[size_local-1] = 3000.01;
    }
    ...
    if (((rank+1)%nprocs < 3)&&(size_to_receive!=0)){
        indices_to_receive[size_to_receive-2] = 2000;
        indices_to_receive[size_to_receive-1] = 3000;
    }
