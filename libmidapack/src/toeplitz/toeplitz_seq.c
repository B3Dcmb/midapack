...
//===================================================\=====================
/// Performs the multiplication of a symmetric, Toeplitz block-diagonal matrix, T,
/// by an arbitrary matrix, V, distributed over processes in the generalized column-wise way.
/** @ingroup group12
    ...
    \param flag_stgy flag strategy for the product computation
*/
int stbmm(double **V, int nrow, int m_cw, int m_rw, Block *tpltzblocks, int nb_blocks, int64_t idp, int local_V_size,
          Flag flag_stgy) {
...
int gstbmm(double **V, int nrow, int m_cw, int m_rw, Block *tpltzblocks, int nb_blocks, int64_t idp, int local_V_size,
    ...
    mpi_gstbmm(V, nrow, m_cw, m_rw, tpltzblocks, nb_blocks, nb_blocks,
               idp, local_V_size, id0gap, lgap, ngap, flag_stgy, comm);
...
int gstbmm0(double **V, int nrow, int m, int m_rowwise, Block *tpltzblocks, int nb_blocks_local, int nb_blocks_all,
            int id0p, int local_V_size, int64_t *id0gap, int *lgap, int ngap, Flag flag_stgy) {
