...
// void apply_Wiener_filter_pixel_working_version(int nside, int lmax, int nstokes, double *CMB_map, double *CMB_map_output, double *c_ells, int number_correlations, double *mask_binary, MPI_Comm worldcomm)
// {
//     // MPI_Init( &argc, &argv);
//     int rank, nprocs;
...
void apply_Wiener_filter_pixel(int nside_, int lmax_, int nstokes_, double *CMB_map_ring_, double *CMB_map_output_, double *c_ells_, int number_correlations_, double *mask_binary_, MPI_Comm worldcomm)
{
    ...
    // local_alm = (s2hat_dcomplex *) malloc( ((3*Global_param_s2hat->nlmax*Global_param_s2hat->nmmax))*sizeof(s2hat_dcomplex));
    local_alm = (s2hat_dcomplex *) calloc( ((3*Global_param_s2hat->nlmax*Global_param_s2hat->nmmax)),sizeof(s2hat_dcomplex));
    ...
    //             Local_param_s2hat->gangsize, Local_param_s2hat->gangrank, Local_param_s2hat->gangcomm);
    double *local_map_pix_out = (double *)calloc(nstokes*Local_param_s2hat->map_size, sizeof(double));
    apply_alm2pix(local_map_pix_out, local_alm, &S2HAT_params);
    // spin=2;
