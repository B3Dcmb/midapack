...
@brief Header file with main definitions and declarations for the Midapack
library
@author Pierre Cargemel, Frederic Dauvergne, Maude Le Jeune, Antoine Rogier,
Radek Stompor
**
** Project:  Midapack library, ANR MIDAS'09
** Purpose:  Provide algebra tools suitable for Cosmic Microwave Background
(CMB) data analysis.
**
***************************************************************************
