/** @file   butterfly.h
    @brief <b> Declaration of routines for butterfly-like communication scheme.
   </b>
   ...
   @nYou should have received a copy of the GNU General Public License along
...
int butterfly_init(int *indices, int count, int **R, int *nR, int **S, int *nS,
                   int **com_indices, int *com_count, int steps, MPI_Comm comm);
